...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51" class="bg-dark">
    <!-- Spinner Start -->
    ...
    <!-- Navbar Start -->
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s" style="background-color: #2C2C2C;">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    <h3 class="text-primary mt-5">I'm</h3>
                    <?php
                    require "connection.php";
                    $name_rs = Database::search("SELECT * FROM `admin`");
                    $name_data = $name_rs->fetch_assoc();
                    ?>
                    <h1 class="display-3 mb-3 text-white"><?php echo $name_data["fname"]; ?></h1>
    ...
    <div class="container-xxl py-6" id="about">
        <div class="container">
                    ...
                    ?>
                        <div class="d-flex align-items-center mb-5">
                            <div class="years flex-shrink-0 text-center me-4">
                                <h1 class="display-1 mb-0 text-white"><?php echo $p_data["YearOf_Exp"]; ?></h1>
                                <h5 class="mb-0 text-white">Years</h5>
                            </div>
                            <h3 class="lh-base mb-0 text-white">of working experience as a web designer & developer</h3>
                        </div>
                        <p class="mb-4 text-white-50"><?php echo $seo_data["about_me"]; ?></p>
                        <p class="mb-3 text-white"><i class="far fa-check-circle text-primary me-3"></i>Afordable Prices</p>
                        <p class="mb-3 text-white"><i class="far fa-check-circle text-primary me-3"></i>High Quality Product</p>
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                ...
                <p class="mb-4 text-white-50"><?php echo $seo_data["clients"]; ?></p>
                <div class="d-flex align-items-center mb-3">
                ...
                <p class="mb-0 text-white-50"><?php echo $seo_data["project"]; ?></p>
            </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl py-6 pb-5" id="skill">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="display-5 mb-5 text-white">Skills & Experience</h1>
                    <p class="mb-4 text-white-50"><?php echo $seo_data["skil_desc"]; ?></p>
                            ...
                            <div class="col-md-6">
                                <div class="skill mb-4">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="font-weight-bold text-white"><?php echo $sk_data["langauge"]; ?></h6>
                                        <h6 class="font-weight-bold text-white"><?php echo $sk_data["percentage"]; ?>%</h6>
                                    </div>
                                    <div class="progress">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <ul class="nav nav-pills rounded border border-2 border-primary mb-5">
                        <li class="nav-item w-50">
                            <button class="nav-link w-100 py-3 fs-5 active text-white" data-bs-toggle="pill" href="#tab-1">Experience</button>
                        </li>
                        <li class="nav-item w-50">
                            <button class="nav-link w-100 py-3 fs-5 text-white" data-bs-toggle="pill" href="#tab-2">Education</button>
                        </li>
                    </ul>
                            ...
                            <div class="row gy-5 gx-4">
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                        ...
                                        <p class="text-white mb-1"><?php echo $exx_data['year']; ?></p>
                            ...
                            <div class="row gy-5 gx-4">
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                        ...
                                        <hr class="text-white my-1">
                                        <p class="text-white mb-1"><?php echo $edd_data['year']; ?></p>
    ...
    <!-- Service Start -->
    <div class="container-fluid bg-dark my-5 py-6" id="service">
        <div class="container">
    ...
    <div class="container-xxl py-6 pt-5" id="project">
        <div class="container">
            <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
                <div class="col-lg-6">
                    <h1 class="display-5 mb-0 text-white">My Tutorial Projects</h1>
                </div>
                <div class="col-lg-6 text-lg-end">
                    <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                        <li class="mx-3 active text-white" data-filter="*">All Tutorials</li>
                        <?php
                        ...
                        ?>
                            <li class="mx-3 text-white" data-filter=".<?php echo $l_data['id']; ?>"><?php echo $l_data['tutorial']; ?></li>
                        <?php } ?>
                    </ul>
            ...
            <div class="row g-4 portfolio-container wow fadeInUp" data-wow-delay="0.1s">
                ...
                ?>
                    <div class="col-lg-4 col-md-6 portfolio-item text-white<?php echo $yt_data['tutorial_proj_id']; ?>">
    ...
    <!-- Testimonial Start -->
    <div class="container-fluid bg-dark py-5 my-5" id="testimonial">
